...
<head>
    ...
    <link rel="stylesheet" href="<?= theme("/assets/css/boot.css", CONF_VIEW_APP); ?>">
    <link rel="stylesheet" href="<?= theme("/assets/css/styles.css", CONF_VIEW_APP); ?>">
...
<script src="<?= theme("/assets/js/jquery.min.js",CONF_VIEW_APP); ?>"></script>
<script src="<?= theme("/assets/js/jquery.form.js", CONF_VIEW_APP); ?>"></script>
<script src="<?= theme("/assets/js/jquery-ui.js", CONF_VIEW_APP); ?>"></script>
<script src="<?= theme("/assets/js/scripts.js", CONF_VIEW_APP); ?>"></script>
<script src="<?= theme("/assets/js/highcharts.js", CONF_VIEW_APP); ?>"></script>
