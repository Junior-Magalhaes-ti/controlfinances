...
<head>
    <meta charset="UTF-8">
    <meta name="mit" content="2022-10-28T16:45:27-03:00+196800">
    ...
    <div class="container content">
        <section class="main_footer_content">
            ...
            <article class="main_footer_content_item social">
                <h2>Social:</h2>
                <a target="_blank" class="icon-facebook" href="https://www.facebook.com.br/ <?= CONF_SOCIAL_FACEBOOK_PAGE;?>"
                   title="CafeControl no Facebook">/CafeControl</a>
                <a target="_blank" class="icon-instagram" href="https://www.instragam.com/ <?= CONF_SOCIAL_INSTAGRAM_PAGE;?>"
                   title="CafeControl no Instagram">@CafeControl</a>
                <a target="_blank" class="icon-youtube" href="https://youtube.com/ <?= CONF_SOCIAL_YOUTUBE_PAGE;?>"
